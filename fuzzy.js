...
var particles = [];
var num_particles = 400;//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM MICROWAVE TIME
...
var Particle = function () {
    ...
    this.vx = 6 * Math.random() - 12;//x axis
    this.vy = 10 * Math.random() - 20;//y axis
